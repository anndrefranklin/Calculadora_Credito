...
daysInMonth[1] = 31;
daysInMonth[2] = 29; // deve verificar isso programaticamente
daysInMonth[3] = 31;
daysInMonth[4] = 30;
daysInMonth[5] = 31;
daysInMonth[6] = 30;
...
function isWhitespace(s) {
  ...
  for (i = 0; i < s.length; i++) {
    // Verifique se o caractere atual não é um espaço em branco.
    var c = s.charAt(i);
...
function isNegativeInteger(s) {
  ...
  // A próxima linha é um pouco bizantina. O que significa é:
  // a) s deve ser um inteiro com sinal, AND
  // b) um dos seguintes deve ser verdadeiro:
  // i) s está vazio e devemos retornar true para
  //strings vazias
  // ii) este é um número negativo, não positivo
